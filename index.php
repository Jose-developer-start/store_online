...
<body id="container-page-index">
    ...
    <div class="jumbotron" id="jumbotron-index">
      <h1><span class="tittles-pages-logo">Technology Box</span> <small style="color: #fff;">El Salvador</small></h1>
      <p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrarse y hagase cliente de <span class="tittles-pages-logo">Technology Box</span> para recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
