...
$tabla = "cliente";
$campos = "NIT, Nombre, NombreCompleto, Apellido, Clave, Direccion, Telefono, Email";
$datos = "'$nitCliente','$nameCliente', '$fullnameCliente', '$apeCliente','$passCliente','$dirCliente','$phoneCliente','$emailCliente'";
...
if(!$nitCliente=="" && !$nameCliente=="" && !$apeCliente=="" && !$dirCliente=="" && !$phoneCliente=="" && !$emailCliente=="" && !$fullnameCliente==""){
    ...
    if($verificaltotal<=0){
        if(consultasSQL::InsertSQL($tabla,$campos,$datos)){
